...
const goBack = () => {
  router.push("/products"); // Redirection vers la liste des produits
};
  ...
  <div v-if="product" class="product-page mt-5">
    ...
    <div class="product-details container py-14">
      <button @click="goBack" class="back-button flex mb-5 hover:text-green-800 font-raleway">
         <ArrowLeftThinCircleOutline class="mr-2"/> Liste de produits
      </button>
      <div class="flex justify-between">
        ...
        <div>
          ...
          <div class="flex mt-10 justify-between">
            <div class="flex">
              <button class="add-panier p-2 text-sm mr-5">Ajouter au panier</button>
              <CardsHeartOutline class="text-gray-800 mt-1"/>
            </div>
            <span class="stock font-raleway text-gray-600"><span class="">{{ product.stock }} en stock</span></span>
          </div>
        </div>
        <AloAlo/>
      </div>
